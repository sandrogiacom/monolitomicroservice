...
docker run -it -v "$PWD/../PerformanceServer/target":/opt/performance --net dockerperformance --ip 172.18.0.6 -h "PerformanceServer" --name "PerformanceServer" -p 8080:8080 -p 4447:4447 --link PerformanceMysql performance/server
