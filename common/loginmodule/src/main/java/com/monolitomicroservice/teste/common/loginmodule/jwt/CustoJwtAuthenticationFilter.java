...
//TODO: Mapear manualmente @WebFilter( "/*" )
public class CustoJwtAuthenticationFilter implements Filter {

    private static final Logger LOG = Logger.getLogger(CustoJwtAuthenticationFilter.class.getName());
